...
class Link extends Teleporter {
  ...
  constructor(name, options, scene) {
    ...
    if (options.locked) {
      this.locked = true;
      this._signHidingDist = this.standSign.hidingDistance;
      this._textHidingDist = this.standSignText.hidingDistance;
      this.standSign.hidingDistance = null;
      this.standSignText.hidingDistance = null;
      this.standSign.setEnabled(false);
      this.standSignText.setEnabled(false);
    }
  }
  ...
  unlock() {
    ...
    this.locked = false;
    this.standSign.hidingDistance = this._signHidingDist;
    this.standSignText.hidingDistance = this._textHidingDist;
    this.standSign.setEnabled(true);
    this.standSignText.setEnabled(true);
  }
